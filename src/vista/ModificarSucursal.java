...
public class ModificarSucursal extends javax.swing.JFrame {

    SucursalDAO dao = new SucursalDAO();
    int codigo = 0;

    public ModificarSucursal(Sucursal sucursal) {
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarSucursal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarSucursal(null).setVisible(true);
            }
        });
    }
